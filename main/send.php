...
$sql="INSERT INTO record(name, phone, address, item, quant, price, trans_id, date, total)VALUES('$name', '$phone', '$address', '$item', '$quant', '$price', '$trans_id', '$date', '$total')";
...
<tr>
  ...
  <tr>
    <td><strong>Item Purchesd:</strong> <br><?php echo "$item"; ?></td>
	<td><strong>Price Per Item:</strong><br> #<?php echo "$price"; ?></td>
  </tr>
  <tr>

...
<form action="add_item_ac.php" method="post" enctype="multipart/form-data">
  <tr>
    <td width="180">Item Name:<input type="text" name="name" placeholder="Enter Item Name" required/></td>
    <td width="201">Item Quantity:<input type="number" name="quant" placeholder="Enter Item Quantity" required/></td>
  </tr>
  <tr>
    <td>Price:<input type="text" name="price" placeholder="Enter Item Price" required/></td>
    <td>
	</td>
  </tr>

...
<table id="table" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="2" width="500">
		<tr>
		<td class="pageName">View Transaction Records </td>
		</tr>
...
$sql="SELECT * FROM record ORDER BY rec_no DESC";
$result=mysql_query($sql);
?>   

<table width="939" height="71" cellpadding="3">
  <tr>
    <th id="th" scope="col"><h2 class="style1">S/N</h2></th>
    <th id="th" scope="col"><h2 class="style1">Item Name</h2></th>
    <th id="th" scope="col"><h2 class="style1">Item Price</h2></th>
    <th id="th" scope="col"><h2 class="style1">Quantity</h2></th>
	<th id="th" scope="col"><h2 class="style1">Total Price</h2></th>
	<th id="th" scope="col"><h2 class="style1">Phone No.</h2></th>
    <th id="th" scope="col"><h2 class="style1">Transaction ID</h2></th>
    <th id="th" scope="col"><h2 class="style1">Customer's Address</h2></th>
  ...
  <tr>
    ...
    <td id="td"><h3><?php echo $rows['name']; ?></h3></td>
    <td id="td"><h3 align="center">#<?php echo $rows['price']; ?></h3></td>
    <td id="td"><h3 align="center"><?php echo $rows['quant']; ?></h3></td>
	<td id="td"><h3 align="center"><?php echo $rows['total']; ?></h3></td>
	<td id="td"><h3 align="center"><?php echo $rows['phone']; ?></h3></td>
	<td id="td"><h3 align="center"><?php echo $rows['trans_id']; ?></h3></td>
	<td id="td"><h3 align="center"><?php echo $rows['address']; ?></h3></td>
  </tr>
  <?php
  }
  mysql_close();
  ?>
   <tr>
    <td id="back" colspan="8" align="center"><a href="index.php">BACK</a></td>
  </tr>
</table>
